...
[charter](https://datatracker.ietf.org/wg/quic/about/). Anyone is welcome to
...
work, you may also want to read the [Getting
Started](https://www.ietf.org/participate/get-started/) page and the many
...
* [IETF meetings](https://www.ietf.org/meeting/) - Agendas, minutes, and presentations are available in our [meeting
...
* Our [mailing list](https://www.ietf.org/mailman/listinfo/quic) is used for
  communication such as notifications of meetings, new drafts, consensus calls
  and other business, as well as issue discussion.
...
Whether you prefer mailing list, GitHub or Slack, the community helps ensure the
topics reach the right people in all places.
