...
We have scheduled an [interim meeting in Zurich](https://github.com/quicwg/wg-materials/blob/master/interim-20-02/arrangements.md), on 5-6 February 2020. After that, will be meeting at [IETF 107 in Vancouver in November](https://www.ietf.org/how/meetings/107/).
...
We have a number of [experimental implementations](https://github.com/quicwg/base-drafts/wiki/Implementations) in progress. The current goal for interop testing is the [14th Implementation Target](https://github.com/quicwg/base-drafts/wiki/14th-Implementation-Draft).
...
* [Late Stage Processing Queue](https://github.com/quicwg/base-drafts/projects/5)
